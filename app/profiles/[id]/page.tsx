...
export default function ProfileEditorPage() {
    ...
    useEffect(() => {
        ...
        if (id && status === "authenticated" && !initializedRef.current) {
            // Only fetch once
            ...
            fetch(`/api/profiles/${id}`)
                ...
                .then((p) => {
                    setProfile(p);
                    setProfileName(p.name || "My Profile");
    ...
    const debouncedName = useDebounce(profileName, 1000);
    const debouncedDescription = useDebounce(profileDescription, 1000);
    ...
    useEffect(() => {
        if (debouncedData && !loading) {
            saveData(debouncedData, debouncedName, debouncedDescription);
        }
    }, [debouncedData, debouncedName, debouncedDescription, loading, saveData]);
            ...
            <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8">
                <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-lg">
                    ...
                    <div className="p-4 sm:p-6 space-y-6 max-h-[calc(100vh-120px)] overflow-y-auto">
                        ...
                        {/* Personal Info - Same structure as new profile page */}
                        ...
                        <div className="pt-4 border-t border-gray-200 dark:border-gray-800">
                            <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
                                Profile auto-saves as you type. Changes are saved automatically.
                            </p>
                        </div>
                    </div>
                </div>
